...
export default function Login() {
  ...
  const userName = useMemo(() => user?.full_name || user?.email || "Usuario", [user]);
    ...
    return (
      <section className="space-y-8">
        ...
        <header className="rounded-3xl bg-gradient-to-br from-blue-950 via-blue-900 to-blue-700 px-6 py-12 text-white shadow-lg lg:px-10">
          <h1 className="text-3xl font-bold sm:text-4xl">Voce ja esta conectado</h1>
          <p className="mt-4 max-w-2xl text-lg text-blue-100">
            Continue explorando o catalogo e acompanhe as novidades da sua garagem inteligente.
          </p>
        </header>
  ...
  return (
    <section className="space-y-8">
      ...
      <header className="rounded-3xl bg-gradient-to-br from-blue-950 via-blue-900 to-blue-700 px-6 py-12 text-white shadow-lg lg:px-10">
        ...
        <p className="mt-4 max-w-2xl text-lg text-blue-100">
          Salve favoritos, sincronize preferencias e acompanhe novidades exclusivas sobre novos modelos.
        </p>
      </header>
      ...
      >
        ...
        <p className="text-sm text-slate-500">
          ...
          <Link
            to="/forgot-password"
            className="ml-2 font-semibold text-blue-700 transition hover:text-blue-600"
          >
            Recuperar acesso
          </Link>
        </p>
